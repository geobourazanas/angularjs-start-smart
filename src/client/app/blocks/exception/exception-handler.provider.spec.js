...
describe('blocks.exception', function() {
    ...
    beforeEach(function() {
        ...
        specHelper.injector(function($rootScope, logger) {});
    });
    ...
    describe('$exceptionHandler', function() {
        ...
        describe('with appErrorPrefix', function() {
            ...
            //     expect(exceptionHandlerProvider.$get().config.appErrorPrefix).to.deep.equal({});
            // }));
            ...
            it('manual error is handled by decorator with undefined config', function() {
                var exception;
                exceptionHandlerProvider.configure(undefined);
                try {
                    $rootScope.$apply(functionThatWillThrow);
                }
                catch (ex) {
